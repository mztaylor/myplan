...
INSERT INTO KSPL_LRNG_PLAN_ITEM (ID, VER_NBR, REF_OBJ_ID, REF_OBJ_TYPE_KEY, TYPE_ID, PLAN_ID, RT_DESCR_ID) VALUES ('lp3-i2', 0, '008739f0-8e62-4f98-88d1-30e6ac779b11', 'kuali.lu.type.CreditCourse', 'kuali.academicplan.item.wishlist', 'lp3', 'lp3-i2-Desc');
...
INSERT INTO KSPL_LRNG_PLAN_ITEM (ID, VER_NBR, REF_OBJ_ID, REF_OBJ_TYPE_KEY, TYPE_ID, PLAN_ID, RT_DESCR_ID) VALUES ('lp4-i1', 0, '0099ce3a-0fe8-4586-96b6-c42f6db7c11e', 'kuali.lu.type.CreditCourse', 'kuali.academicplan.item.whatif', 'lp4', 'lp4-u1-Desc');
...
//INSERT INTO  KSPL_LRNG_PL_IT_ATP_RELTN (PLAN_ITEM_ID, ATP_ID) VALUES ('lp1-i4', 'testTermId3');

//INSERT INTO  KSPL_LRNG_PL_IT_ATP_RELTN (PLAN_ITEM_ID, ATP_ID) VALUES ('lp1-i5', 'testTermId1');
//INSERT INTO  KSPL_LRNG_PL_IT_ATP_RELTN (PLAN_ITEM_ID, ATP_ID) VALUES ('lp1-i5', 'testTermId2');

//INSERT INTO  KSPL_LRNG_PL_IT_ATP_RELTN (PLAN_ITEM_ID, ATP_ID) VALUES ('lp1-i6', 'testTermId1');
//INSERT INTO  KSPL_LRNG_PL_IT_ATP_RELTN (PLAN_ITEM_ID, ATP_ID) VALUES ('lp1-i6', 'testTermId2');
//INSERT INTO  KSPL_LRNG_PL_IT_ATP_RELTN (PLAN_ITEM_ID, ATP_ID) VALUES ('lp1-i6', 'testTermId3');

//INSERT INTO  KSPL_LRNG_PL_IT_ATP_RELTN (PLAN_ITEM_ID, ATP_ID) VALUES ('lp4-i2', 'testTermId1');
//INSERT INTO  KSPL_LRNG_PL_IT_ATP_RELTN (PLAN_ITEM_ID, ATP_ID) VALUES ('lp4-i2', 'testTermId3');