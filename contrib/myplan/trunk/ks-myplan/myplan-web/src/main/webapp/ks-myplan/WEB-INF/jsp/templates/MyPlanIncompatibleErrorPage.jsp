...
<div id="container">
    ...
    <div id="content">
        ...
        <p>It appears that your browser needs to be updated in order to view MyPlan. <br><a href="http://depts.washington.edu/myplan/help-site/">Visit the Help page</a> to learn more about compatible browsers.</p>
    </div>
