...
public class CommentConstants extends CommentServiceConstants {
    ...
    public static final String MESSAGE_TYPE = "kuali.comment.type.academicPlanning.message";
    public static final String COMMENT_TYPE = "kuali.comment.type.academicPlanning.message.comment";
    public static final String MESSAGE_REF_TYPE = "kuali.comment.referenceType.person";
    public static final String COMMENT_REF_TYPE = "kuali.comment.referenceType.academicPlanning.message";
