...
public interface TermHelper {
     ...
     */
    Term getTermByAtpId(String atpId);
    ...
    /**
     * Checks if termId provided is open for registration or not.
     *
     * @param termId
    ...
    /**
     * used to get the priority registration start date from given termDocument.
     *
     * @param termDocument
     * @return
     */
    ...
    /**
     * used to get the priority registration end date from given termDocument.
     *
     * @param termDocument
     * @return
     */
