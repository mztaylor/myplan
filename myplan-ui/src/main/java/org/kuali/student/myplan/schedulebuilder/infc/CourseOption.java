...
public interface CourseOption extends ScheduleBuildOption, Comparable<CourseOption>, Serializable {
     ...
     *
     * @param includeClosed True to include closed sections in the count, false to exclude
     *                      closed sections.
    ...
    /**
     * Course level errors are defined here.
     *
     * @return PossibleScheduleErrors which has the error Type, error messages.
     */
