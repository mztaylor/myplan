                ...
                if (req.isAddToCart()) {
                    ...
                    if (preg != null) {
                        ...
                        ActivityOptionInfo ao = (ActivityOptionInfo)
                                sb.getActivityOption(pso.getTermId(), req.getCourse().getId(), req.getCourse().getCode(), preg, new LinkedHashMap<String, LinkedHashMap<String, Object>>());
                        // used to tie processing results in to the front end
                    ...
                    if (sreg != null)
                        for (String reg : sreg) {
                            ...
                            removeList.add(sb.getActivityOption(pso.getTermId(), req.getCourse()
                                    .getId(), req.getCourse().getCode(), reg, new LinkedHashMap<String, LinkedHashMap<String, Object>>()));
                        }
                }
            }
