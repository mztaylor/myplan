...
public interface ScheduleBuildEvent extends Serializable {
    ...
    /**
     * Get the days in a condensed form, for easy reading.
     *
     * @return The days, for easy reading.
     */
    List<String> getDays();

    /**
     * Get the times in a condensed form, for easy reading.
     *
     * @return The times, for easy reading.
     */
    String getTimes();
